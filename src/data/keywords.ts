...
export const KEYWORDS: KeywordEntry[] = [
  {
    id: 'ACCESS POINT',
    name: { en: 'ACCESS POINT', ko: '액세스 포인트' },
    definition: {
  ...
  {
    id: 'ACTIVE PLAYER',
    name: { en: 'ACTIVE PLAYER', ko: '액티브 플레이어' },
    definition: {
  ...
  {
    id: 'ANTI-EVADE (X)',
    name: { en: 'ANTI-EVADE (X)', ko: '안티-회피(X)' },
    definition: {
  ...
  {
    id: 'BLOCKING TERRAIN',
    name: { en: 'BLOCKING TERRAIN', ko: '시야 차단 지형' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'BUFF [Characteristic] (X)', ko: '버프 [능력치](X)' },
    definition: {
  ...
  {
    id: 'BURST FIRE Y" (X)',
    name: { en: 'BURST FIRE Y" (X)', ko: '버스트 파이어 Y"(X)' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'CONCENTRATED FIRE (X)', ko: '집중된 사격(X)' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'CONTROLLING PLAYER', ko: '조종하는 플레이어' },
    definition: {
  ...
  {
    id: 'CRITICAL HIT (X)',
    name: { en: 'CRITICAL HIT (X)', ko: '크리티컬 힛(X)' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'DEBUFF [Characteristic] (X)', ko: '디버프 [능력치](X)' },
    definition: {
  ...
  {
    id: 'EFFECTIVE SIZE',
    name: { en: 'EFFECTIVE SIZE', ko: '유효 사이즈' },
    definition: {
  ...
  {
    id: 'ENGAGEMENT RANGE',
    name: { en: 'ENGAGEMENT RANGE', ko: '인게이지 거리' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'FIRST PLAYER MARKER', ko: '선공권 마커' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'IMPASSABLE TERRAIN', ko: '통과 불가능한 지형' },
    definition: {
  ...
  {
    id: 'INDIRECT FIRE',
    name: { en: 'INDIRECT FIRE', ko: '인다이렉트 파이어' },
    definition: {
  ...
  {
    id: 'LEADING MODEL',
    name: { en: 'LEADING MODEL', ko: '리딩 모델' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'LINE OF SIGHT (LoS)', ko: '시야(LoS)' },
    definition: {
  ...
  {
    id: 'LONG RANGE (X)',
    name: { en: 'LONG RANGE (X)', ko: '롱 레인지(X)' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'NON-LETHAL DAMAGE (X)', ko: '논 리썰 데미지(X)' },
    definition: {
  ...
  {
    id: 'PIERCE [TAG] X',
    name: { en: 'PIERCE [TAG] X', ko: '관통-[태그] X' },
    definition: {
  ...
  {
    id: 'SPECIAL ABILITY',
    name: { en: 'SPECIAL ABILITY', ko: '특수능력' },
    definition: {
  ...
  {
    id: 'SUMMON (Unit Name)',
    name: { en: 'SUMMON (Unit Name)', ko: '소환(Unit Name)' },
    definition: {
  ...
  {
    id: 'SUPPORTING RANK',
    name: { en: 'SUPPORTING RANK', ko: '지원열' },
    definition: {
  ...
  {
    id: 'UNENGAGED',
    name: { en: 'UNENGAGED', ko: '인게이지 상태가 아닌' },
    definition: {
  ...
  {
    id: 'WHOLLY WITHIN',
    name: { en: 'WHOLLY WITHIN', ko: '완전히 안에' },
    definition: {
  ...
  },
  {
    ...
    name: { en: 'ZONE OF INFLUENCE', ko: '영향권' },
    definition: {
