...
export const vileRoach: UnitCard = {
  category: 'unit',
  id: 'Vile (Roach)',
  name: { en: 'Vile (Roach)', ko: 'Vile (Roach)' },
  isUnique: false,
  type: 'Core',
  stat: {
    shld: null,
  ...
  abilities: [
    {
      ...
      name: { en: 'Debilitating Saliva', ko: 'Debilitating Saliva' },
      phase: 'Any',
      type: 'Reaction',
      cost: 1,
      rule: {
    ...
    },
    {
      ...
      rule: {
        ...
        ko: '이 유닛이 성공적으로 차지를 마쳤을 때 즉시 4+로 임팩트(1)를 입힌다.',
      },
    },
    {
      kind: 'weapon',
      id: 'Vile Claws',
      name: { en: 'Vile Claws', ko: 'Vile Claws' },
      phase: 'Combat',
      stat: {
        rng: 'E',
        tgt: 'Ground',
